...
You can access the sample Arduino code that writes the data received from this program in json format by clicking [here](https://github.com/mertkalandar/rocket-ground-station-hardware-code).
